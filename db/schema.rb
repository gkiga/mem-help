...
ActiveRecord::Schema.define(version: 2020_11_15_024236) do
  ...
  create_table "global_listings", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "globals", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "user_id"
    t.bigint "global_listing_id"
    t.index ["global_listing_id"], name: "index_globals_on_global_listing_id"
  end
  ...
  add_foreign_key "globals", "global_listings"
